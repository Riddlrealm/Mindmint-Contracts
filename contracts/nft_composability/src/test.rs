...
fn test_nft_composability_flow() {
    ...
    selections.push_back(TraitSelection {
        trait_key: Symbol::new(&env, "Color"),
        source: 1,
    });
    selections.push_back(TraitSelection {
        trait_key: Symbol::new(&env, "Weapon"),
        source: 2,
    });

...
impl TournamentContract {
    pub fn initialize(e: Env, admin: Address, token: Address, entry_fee: i128) {
        ...
        e.storage()
            .instance()
            .set(&DataKey::State, &TournamentState::Open);
    ...
    pub fn register(e: Env, player: Address) {
        ...
        e.storage()
            .instance()
            .set(&DataKey::TotalPrize, &total_prize);
    ...
    pub fn start_tournament(e: Env) {
        ...
        e.storage()
            .instance()
            .set(&DataKey::State, &TournamentState::Started);
    ...
    pub fn record_result(e: Env, winner: Address) {
        ...
        e.storage()
            .instance()
            .set(&DataKey::State, &TournamentState::Ended);
    ...
    pub fn cancel_tournament(e: Env) {
        ...
        e.storage()
            .instance()
            .set(&DataKey::State, &TournamentState::Cancelled);
    ...
    pub fn withdraw_refund(e: Env, player: Address) {
        ...
        e.storage()
            .instance()
            .set(&DataKey::Participants, &new_participants);
    }
